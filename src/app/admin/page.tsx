...
type SettingsResp = { ok: boolean; settings?: { accessGateEnabled?: boolean }; error?: string };
...
export default function AdminPage() {
  ...
  const load = async (overrideToken?: string) => {
    ...
    try {
      ...
      if (jsonSettings.ok) {
        const enabled = jsonSettings.settings?.accessGateEnabled;
        if (typeof enabled === 'boolean') setAccessGateEnabled(enabled);
      }
